...
for opt_type in opt_try:
    ...
    portVal.to_pickle(path_to_results + '{}_{}_lookback{}_value.pkl'.format(opt_type.value, datatype, lookback))
    holdings.to_pickle(path_to_results + '{}_{}_lookback{}_holdings.pkl'.format(opt_type.value, datatype, lookback))
